...
(function () {
  ...
  function Xa(h, n, F) {
    "millisecond" === F
      ...
      : "year" === F && h.setFullYear(h.getFullYear() + 1 * n);
    return h;
  }
  function aa(h, n) {
    var F = !1;
  ...
  function Ha(h) {
    if (!h) return h;
    h = h.replace(/^\s\s*/, "");
    for (var n = /\s/, F = h.length; n.test(h.charAt(--F)); );
    return h.slice(0, F + 1);
  }
  function Da(h) {
    h.roundRect = function (h, F, q, w, sa, A, v, C) {
      v && (this.fillStyle = v);
      ...
      this.beginPath();
      this.moveTo(h + sa, F);
      this.lineTo(h + q - sa, F);
      this.quadraticCurveTo(h + q, F, h + q, F + sa);
      this.lineTo(h + q, F + w - sa);
      this.quadraticCurveTo(h + q, F + w, h + q - sa, F + w);
      this.lineTo(h + sa, F + w);
      this.quadraticCurveTo(h, F + w, h, F + w - sa);
      this.lineTo(h, F + sa);
  ...
  function fb(h, n) {
    var F = this.length >>> 0,
      q = Number(n) || 0,
      q = 0 > q ? Math.ceil(q) : Math.floor(q);
    for (0 > q && (q += F); q < F; q++)
      if (q in this && this[q] === h) return q;
    return -1;
  }
  function q(h) {
  ...
  function I(h, n) {
    ...
    if (
      ...
      for (var q = 0; q < F.length; q++) F[q] *= n;
    else F = [];
    return F;
  }
  function J(h, n, F, w, ba) {
    w = w || [];
    ba = q(ba) ? (hb ? { passive: !1, capture: !1 } : !1) : ba;
    w.push([h, n, F, ba]);
    return h.addEventListener
      ? (h.addEventListener(n, F, ba), F)
      : h.attachEvent
      ? ((w = function (n) {
          n = n || window.event;
          n.preventDefault =
  ...
  function ib(h) {
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (
        var F = h._dropdownMenu.childNodes,
          q = [
      ...
      !h._dropdownMenu &&
        ...
        (F = -1 !== h.theme.indexOf("dark") ? "black" : "#888888"),
        U(h._dropdownMenu, {
          position: "absolute",
          zIndex: 1,
          userSelect: "none",
        ...
        U(F, { padding: "12px 8px 12px 8px" }),
        (F.innerHTML = h._cultureInfo.printText),
        (F.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (F.style.color = h.toolbar.fontColor),
        ...
        (F = document.createElement("div")),
        U(F, { padding: "12px 8px 12px 8px" }),
        (F.innerHTML = h._cultureInfo.saveJPGText),
        (F.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (F.style.color = h.toolbar.fontColor),
        h._dropdownMenu.appendChild(F),
        J(
        ...
        (F = document.createElement("div")),
        U(F, { padding: "12px 8px 12px 8px" }),
        (F.innerHTML = h._cultureInfo.savePNGText),
        (F.style.backgroundColor = h.toolbar.itemBackgroundColor),
        (F.style.color = h.toolbar.fontColor),
        h._dropdownMenu.appendChild(F),
        J(
  ...
  function ma(h, n, F) {
    return h in n ? n[h] : F[h];
  }
  function Na(h, n, F) {
    if (w && ab) {
      var q = h.getContext("2d");
      Oa =
        q.webkitBackingStorePixelRatio ||
        q.mozBackingStorePixelRatio ||
        q.msBackingStorePixelRatio ||
        q.oBackingStorePixelRatio ||
  ...
  function jb(h) {
    if (!kb) {
      ...
      "undefined" === typeof ra.Chart.creditHref
        ? ((h.creditHref = ka("iuuqr;..b`ow`rkr/bnl.")),
          (h.creditText = ka("B`ow`rKR/bnl")))
        : ((n = h.updateOption("creditText")),
          (q = h.updateOption("creditHref")));
  ...
  function xa(h, n, q) {
    ...
    n.getAttribute("state") !== q &&
      (n.setAttribute("state", q),
      ...
      n.setAttribute("title", h._cultureInfo[q + "Text"]),
      (n.innerHTML =
        "<img src='" +
        lb[q].image +
        "' alt='" +
        h._cultureInfo[q + "Text"] +
        "' />"),
      U(n.childNodes[0], { height: "95%", pointerEvents: "none" }));
  }
  function Ma() {
  ...
  function Ta(h, n, q, w, ba) {
    if (null === h || "undefined" === typeof h)
      return "undefined" === typeof q ? n : q;
    h =
      parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? n / 100 : 1);
    "undefined" !== typeof w &&
      ((h = Math.min(w, h)),
      "undefined" !== typeof ba && (h = Math.max(ba, h)));
    return !isNaN(h) && h <= n && 0 <= h ? h : "undefined" === typeof q ? n : q;
  }
  function V(h, n, F, w, ba) {
    this._defaultsKey = h;
    ...
    h = {};
    this.theme && q(this.parent) && q(n) && q(w)
      ? (h = q(this.predefinedThemes[this.theme])
  ...
  function Fa(h, n, q, w, ba) {
    "undefined" === typeof ba && (ba = 0);
    this._padding = ba;
    this._x1 = h;
    this._y1 = n;
    this._x2 = q;
  ...
  function za(h, n) {
    ...
    if (q(this.options.margin) && h.options.subtitles)
      for (var F = h.options.subtitles, w = 0; w < F.length; w++)
        if (
          ((q(F[w].horizontalAlign) && "center" === this.horizontalAlign) ||
            F[w].horizontalAlign === this.horizontalAlign) &&
          ((q(F[w].verticalAlign) && "top" === this.verticalAlign) ||
            F[w].verticalAlign === this.verticalAlign) &&
          !F[w].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  function Ja(h, n, q) {
    Ja.base.constructor.call(this, "Subtitle", "subtitles", n, q, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
  ...
  var ha = 20,
    ...
    Ba = (function () {
      ...
      return function (C, I, R) {
        ...
        var U = C[R + "Date"](),
          ...
          b = C[R + "Seconds"](),
          e = C[R + "Milliseconds"](),
          f = T ? 0 : C.getTimezoneOffset();
        return (R = I.replace(h, function (l) {
          switch (l) {
            case "D":
              return U;
            case "DD":
            ...
            case "ss":
              return aa(b, 2);
            case "f":
              return aa(String(e), 3).slice(0, 1);
            case "ff":
              return aa(String(e), 3).slice(0, 2);
            case "fff":
              return aa(String(e), 3).slice(0, 3);
            case "t":
              return 12 > d ? "a" : "p";
            case "tt":
              return 12 > d ? "am" : "pm";
            ...
            case "K":
              return T
                ? "UTC"
                : (String(C).match(v) || [""]).pop().replace(A, "");
            case "z":
    ...
    Y = function (h, n, q) {
      ...
      var w = 0 > h ? !0 : !1;
      w && (h *= -1);
      var ba = q ? q.decimalSeparator : ".",
        v = q ? q.digitGroupSeparator : ",",
        A = "";
      n = String(n);
      var A = 1,
        C = (q = ""),
        ...
        if (((n = C[N]), "." === n && 0 > I)) I = N;
          ...
          if ("%" === n) A *= 100;
            ...
            ("E" !== n[0] && "e" !== n[0]) ||
              ...
              (T = !0);
          0 > I
            ? (R.push(n), "#" === n || "0" === n ? O++ : "," === n && K++)
            : (P.push(n), ("#" !== n && "0" !== n) || J++);
        }
      T &&
        ((n = Math.floor(h)),
        (C = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (U = 0 === h ? 0 : 0 === n ? -(O + C) : String(n).length - O),
        (A /= Math.pow(10, U)));
      0 > I && (I = N);
      A = (h * A).toFixed(J);
      n = A.split(".");
      ...
      h = (n[1] + "").split("");
      A && "0" === A[0] && A.shift();
      for (T = C = N = J = I = 0; 0 < R.length; )
        if (((n = R.pop()), "#" === n || "0" === n))
          if ((I++, I === O)) {
            var Z = A,
              A = [];
            if ("0" === n)
              for (n = O - J - (Z ? Z.length : 0); 0 < n; ) Z.unshift("0"), n--;
            for (; 0 < Z.length; )
              (q = Z.pop() + q),
                T++,
                0 === T % C && N === K && 0 < Z.length && (q = v + q);
          } else
            0 < A.length
              ? ((q = A.pop() + q), J++, T++)
              : "0" === n && ((q = "0" + q), J++, T++),
              0 === T % C && N === K && 0 < A.length && (q = v + q);
        else
          ("E" !== n[0] && "e" !== n[0]) ||
          "0" !== n[n.length - 1] ||
          !/[eE][+-]*[0]+/.test(n)
            ? "," === n
              ? (N++, (C = T), (T = 0), 0 < A.length && (q = v + q))
              : (q =
                  1 < n.length &&
                  (('"' === n[0] && '"' === n[n.length - 1]) ||
                    ("'" === n[0] && "'" === n[n.length - 1]))
                    ? n.slice(1, n.length - 1) + q
                    : n + q)
            : ((n =
                0 > U
                  ? n.replace("+", "").replace("-", "")
                  : n.replace("-", "")),
              (q += n.replace(/[0]+/, function (a) {
                return aa(U, a.length);
              })));
      v = "";
      for (R = !1; 0 < P.length; )
        (n = P.shift()),
    ...
    Pa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((n = h.offsetX), (q = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((n = h.layerX), (q = h.layerY))
        : ((n = h.pageX - h.target.offsetLeft),
          (q = h.pageY - h.target.offsetTop));
      return { x: n, y: q };
    },
    ab = !0,
    ...
    Oa = 1,
    la = ab ? Sa / Oa : 1,
    ca = function (h, n, q, w, v, C, A, I, O, R, T, P, J) {
      "undefined" === typeof J && (J = 1);
      A = A || 0;
      I = I || "black";
      var K = 15 < w - n && 15 < v - q ? 8 : 0.35 * Math.min(w - n, v - q);
      h.beginPath();
      h.moveTo(n, q);
      h.save();
      h.fillStyle = C;
      h.globalAlpha = J;
      h.fillRect(n, q, w - n, v - q);
      h.globalAlpha = 1;
      0 < A &&
        ((J = 0 === A % 2 ? 0 : 0.5),
        h.beginPath(),
        ...
        (h.strokeStyle = I),
        h.moveTo(n, q),
        h.rect(n - J, q - J, w - n + 2 * J, v - q + 2 * J),
        h.stroke());
      h.restore();
      !0 === O &&
        (h.save(),
        ...
        h.lineTo(w, q),
        h.closePath(),
        (A = h.createLinearGradient((w + n) / 2, q + K, (w + n) / 2, q)),
        A.addColorStop(0, C),
      ...
      !0 === T &&
        ...
        h.lineTo(n, v),
        h.closePath(),
        (A = h.createLinearGradient(n + K, (v + q) / 2, n, (v + q) / 2)),
        A.addColorStop(0, C),
      ...
      !0 === P &&
        ...
        h.lineTo(w - K, v - K),
        h.lineTo(w, v),
        (A = h.createLinearGradient(w - K, (v + q) / 2, w, (v + q) / 2)),
        A.addColorStop(0, C),
        A.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = A),
        A.addColorStop(0, C),
    ...
    ka = function (h) {
      for (var n = "", q = 0; q < h.length; q++)
        n += String.fromCharCode(
          Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(q)
        );
      return n;
    },
    db =
      window &&
      window[ka("mnb`uhno")] &&
      window[ka("mnb`uhno")].href &&
      window[ka("mnb`uhno")].href.indexOf &&
      (-1 !== window[ka("mnb`uhno")].href.indexOf(ka("b`ow`rkr/bnl")) ||
        -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gdonqhy/bnl")) ||
        -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gheemd"))),
    kb = db && -1 === window[ka("mnb`uhno")].href.indexOf(ka("gheemd")),
    lb = {
      reset: {
        image:
  ...
  (function () {
    ...
    T.pos = ["cm", "cs", "um"];
    T._fTWm = function (h) {
      if ("undefined" === typeof T.pro.sCH && !db)
        try {
          var n = new Date().getMonth() % 3,
            q,
            w,
            v = h[T.fSDec("buy")];
          v[T.fSDec("udyuC`rdmhod")] = T.fSDec("unq");
          v[T.fSDec("gnou")] =
            11 +
            T.fSDec(
              "qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg"
            );
          v[T.fSDec("ghmmRuxmd")] = T.fSDec("fsdx");
          q =
            "cm" === T.pos[n] || "um" === T.pos[n]
              ? 0
              : h.width -
                v[T.fSDec("ld`rtsdUdyu")](T.fSDec("B`ow`rKR!Ush`m")).width;
          w = "um" === T.pos[n] ? 0 : h.height - 11;
          v[T.fSDec("ghmmUdyu")](T.fSDec("B`ow`rKR!Ush`m"), q, w);
          "cs" === T.pos[n] &&
            (h[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"));
        } catch (C) {}
    };
  })();
  V.prototype.setOptions = function (h, n) {
    if (ra[this._defaultsKey]) {
      ...
      for (w in q)
        "publicProperties" !== w &&
          q.hasOwnProperty(w) &&
          (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : q[w]);
  ...
  V.prototype.set = function (h, n, q) {
    ...
    q && (this.stockChart || this.chart || this).render();
  };
  V.prototype.addTo = function (h, n, q, w) {
    ...
    (v.publicProperties &&
      ...
      ? (this.options._isPlaceholder && this.createUserOptions(),
        ...
        (h = this.options[h]),
        (q = "undefined" === typeof q || null === q ? h.length : q),
        h.splice(q, 0, n),
    ...
    if ("undefined" !== typeof h || this.options._isPlaceholder)
      if (
        ...
        var n = this.parent.options[this.optionsName],
          q = n.length;
        this.options._isPlaceholder || (Ea(n), (q = n.indexOf(this.options)));
        ...
        (this.options = "undefined" === typeof h ? {} : h),
          ...
          this.optionsName
            ...
            ? ((q = n.charAt(0).toLowerCase()),
              1 < n.length && (q = q.concat(n.slice(1))),
              (n = q))
            : (n = void 0),
          (h[n] = this.options);
  };
  ...
  V.prototype.updateOption = function (h) {
    ...
    var n = ra[this._defaultsKey],
      ...
      I = this._index;
    this.theme && q(this.parent) && q(C) && q(I)
      ? (w = q(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[C] &&
        (null === I
          ? (w = this.parent.themeOptions[C])
          : 0 < this.parent.themeOptions[C].length &&
            ((w = Math.min(this.parent.themeOptions[C].length - 1, I)),
            (w = this.parent.themeOptions[C][w])));
    this.themeOptions = w;
    h in n &&
  ...
  V.prototype.addEventListener = function (h, n, q) {
    h &&
      n &&
      ((this._eventListeners[h] = this._eventListeners[h] || []),
      this._eventListeners[h].push({ context: q || this, eventHandler: n }));
  };
  V.prototype.removeEventListener = function (h, n) {
    if (h && n && this._eventListeners[h])
      for (var q = this._eventListeners[h], w = 0; w < q.length; w++)
        if (q[w].eventHandler === n) {
          q[w].splice(w, 1);
          break;
        }
  };
  ...
  ja.prototype._initialize = function () {
    q(this.padding) || "object" !== typeof this.padding
      ? (this.topPadding =
          this.rightPadding =
          this.bottomPadding =
          this.leftPadding =
            Number(this.padding) | 0)
      : ((this.topPadding = q(this.padding.top)
          ? 0
          : Number(this.padding.top) | 0),
        (this.rightPadding = q(this.padding.right)
          ? 0
          : Number(this.padding.right) | 0),
        (this.bottomPadding = q(this.padding.bottom)
          ? 0
          : Number(this.padding.bottom) | 0),
        (this.leftPadding = q(this.padding.left)
          ? 0
  ...
  ja.prototype.render = function (h) {
    if (0 !== this.fontSize) {
      ...
      for (q = 0; q < this._wrappedText.lines.length; q++) {
        C = this._wrappedText.lines[q];
        if ("right" === this.horizontalAlign || "right" === this.textAlign)
          w = this.width - C.width - this.rightPadding;
  ...
  ja.prototype._getLineWithWidth = function (h, n, q) {
    h = String(h);
    ...
    for (this.ctx.font = this._getFontString(); w <= v; ) {
      var C = Math.floor((w + v) / 2),
        A = h.substr(0, C + 1);
      q = this.ctx.measureText(A).width;
      if (q < n) w = C + 1;
      else if (q > n) v = C - 1;
      else break;
    }
    q > n &&
      1 < A.length &&
      ((A = A.substr(0, A.length - 1)), (q = this.ctx.measureText(A).width));
    n = !0;
  ...
  ja.prototype._wrapText = function () {
    ...
    if (0 === this.frontSize) v = w = 0;
      ...
      for (; 0 < h.length; ) {
        var C = this.maxHeight - (this.topPadding + this.bottomPadding),
  ...
  za.prototype.setLayout = function () {
    if (this.text) {
      ...
      q(this.padding) || "number" !== typeof this.padding
        ? q(this.padding) ||
          ...
          ((R = this.padding.top
            ...
            ? this.padding.bottom
            : 0),
          (R += this.padding.bottom
            ? this.padding.bottom
            : this.padding.top
            ? this.padding.top
            : 0))
        : (R = 2 * this.padding);
      this.wrap || (I = Math.min(I, 1.5 * this.fontSize + R));
      I = new ja(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((v = n.y2 - 2 - R.height), (J = "bottom")),
          "left" === this.horizontalAlign
            ? (w = n.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = n.x1 + n.width / 2 - R.width / 2)
            : "right" === this.horizontalAlign && (w = n.x2 - 2 - R.width - A),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = n.x1 + 2),
              (v = n.y2 - 2 - (this.maxWidth / 2 - R.width / 2)),
              (C = -90),
              (J = "left"),
              (this.width = R.height),
              (this.height = R.width))
            ...
            ? ((w = n.x2 - 2),
              (v = n.y1 + 2 + (this.maxWidth / 2 - R.width / 2)),
              (C = 90),
              (J = "right"),
              (this.width = R.height),
              (this.height = R.width))
            : "center" === this.horizontalAlign &&
              ((v = h.y1 + (h.height / 2 - R.height / 2)),
              (w = h.x1 + (h.width / 2 - R.width / 2)),
              (J = "center"),
              (this.width = R.width),
              (this.height = R.height)),
          (K = "center"));
      ...
      h.layoutManager.registerSpace(J, {
        width:
          this.width + ("left" === J || "right" === J ? this.margin + 2 : 0),
        height:
          this.height + ("top" === J || "bottom" === J ? this.margin + 2 : 0),
      });
  ...
  Va.prototype.get = function (h, q) {
    var w = null;
    0 < this.pool.length
      ? ((w = this.pool.pop()), Na(w, h, q))
      : (w = va(h, q));
    return w;
  };
  ...
  qa(Ka, V);
  var Qa = {
    addTheme: function (h, q) {
      cb[h] = q;
    },
    addColorSet: function (h, q) {
      Aa[h] = q;
    },
    addCultureInfo: function (h, q) {
      La[h] = q;
    },
    formatNumber: function (h, q, w) {
      w = w || "en";
      if (La[w]) return Y(h, q || "#,##0.##", new Ka(w));
      throw "Unknown Culture Name";
    },
    formatDate: function (h, q, w) {
      w = w || "en";
      if (La[w]) return Ba(h, q || "DD MMM YYYY", new Ka(w));
      throw "Unknown Culture Name";
    },
  };
  ...
  v = Qa.Chart = (function () {
    ...
    function n(a, d, c) {
      ...
      this.theme =
        q(d.theme) || q(this.predefinedThemes[d.theme]) ? "light1" : d.theme;
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[l].y - a[f].y) / b;
          c[c.length] =
            (a[s].x > a[f].x && 0 < B) || (a[s].x < a[f].x && 0 > B)
              ? { x: a[s].x + B / 3, y: a[s].y + b / 3 }
              : { x: a[s].x, y: a[s].y + b / 9 };
          s = e;
          f = 0 === s ? 0 : s - 1;
          l = s === a.length - 1 ? s : s + 1;
    ...
    function C(a, d, c, b, e, f, l, s, B, k) {
      var m = 0;
    ...
    function ha(a, d, c, b) {
      ha.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", d, null, b);
      this.id = c;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = b;
    ...
    function fa(a, d, c, b, e, f) {
      fa.base.constructor.call(this, "Break", d, c, b, f);
      this.id = e;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.scaleBreaks = f;
      ...
      this.fillOpacity = q(c.fillOpacity) ? f.fillOpacity : this.fillOpacity;
      this.lineThickness = q(c.lineThickness)
        ? f.lineThickness
        : this.lineThickness;
    ...
    function R(a, d, c, b, e) {
      R.base.constructor.call(this, "StripLine", "stripLines", d, c, e);
      this.id = b;
      this.chart = a;
      this.ctx = this.chart.ctx;
    ...
    n.prototype.setLayout = function () {
      ...
      if (
        ...
        for (d = 0; d < this._axes.length; d++)
          if (
            !q(this._axes[d].viewportMinimum) ||
            !q(this._axes[d].viewportMaximum)
          ) {
            c = !0;
            break;
          }
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          "line" === s.type
            ? (B = this.renderLine(s))
            : "stepLine" === s.type
            ? (B = this.renderStepLine(s))
            : "spline" === s.type
            ? (B = this.renderSpline(s))
            : "column" === s.type
            ? (B = this.renderColumn(s))
            : "bar" === s.type
            ? (B = this.renderBar(s))
            : "area" === s.type
            ? (B = this.renderArea(s))
            : "stepArea" === s.type
            ? (B = this.renderStepArea(s))
            : "splineArea" === s.type
            ? (B = this.renderSplineArea(s))
            : "stackedColumn" === s.type
            ? (B = this.renderStackedColumn(s))
            : "stackedColumn100" === s.type
            ? (B = this.renderStackedColumn100(s))
            : "stackedBar" === s.type
            ? (B = this.renderStackedBar(s))
            : "stackedBar100" === s.type
            ? (B = this.renderStackedBar100(s))
            : "stackedArea" === s.type
            ? (B = this.renderStackedArea(s))
            : "stackedArea100" === s.type
            ? (B = this.renderStackedArea100(s))
            : "bubble" === s.type
            ? (B = B = this.renderBubble(s))
            : "scatter" === s.type
            ? (B = this.renderScatter(s))
            : "pie" === s.type
            ? this.renderPie(s)
            : "doughnut" === s.type
            ? this.renderPie(s)
            : "funnel" === s.type
            ? (B = this.renderFunnel(s))
            : "pyramid" === s.type
            ? (B = this.renderFunnel(s))
            : "candlestick" === s.type
            ? (B = this.renderCandlestick(s))
            : "ohlc" === s.type
            ? (B = this.renderCandlestick(s))
            : "rangeColumn" === s.type
            ? (B = this.renderRangeColumn(s))
            : "error" === s.type
            ? (B = this.renderError(s))
            : "rangeBar" === s.type
            ? (B = this.renderRangeBar(s))
            : "rangeArea" === s.type
            ? (B = this.renderRangeArea(s))
            : "rangeSplineArea" === s.type
            ? (B = this.renderRangeSplineArea(s))
            : "waterfall" === s.type
            ? (B = this.renderWaterfall(s))
            : "boxAndWhisker" === s.type && (B = this.renderBoxAndWhisker(s));
          for (var k = 0; k < s.dataSeriesIndexes.length; k++)
            this._dataInRenderedOrder.push(this.data[s.dataSeriesIndexes[k]]);
          this.animatedRender &&
            ((s.targetCanvasCtx.miterLimit = e), B && c.push(B));
        }
          ...
          if ("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement)
            var r = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (s.dataPoints[B].x && s.dataPoints[B].x.getTime) ||
            "dateTime" === s.xValueType
          )
            f = !0;
          for (B = 0; B < s.dataPoints.length; B++) {
            "undefined" === typeof s.dataPoints[B].x &&
              (s.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0));
            s.dataPoints[B].x.getTime
              ? ((f = !0), (b = s.dataPoints[B].x.getTime()))
              : (b = s.dataPoints[B].x);
            e = s.dataPoints[B].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < B) {
              if (a.axisX.logarithmic) {
                var t = b / s.dataPoints[B - 1].x;
                1 > t && (t = 1 / t);
                c.minDiff > t && 1 !== t && (c.minDiff = t);
              } else
                (t = b - s.dataPoints[B - 1].x),
                  0 > t && (t *= -1),
                  c.minDiff > t && 0 !== t && (c.minDiff = t);
              null !== e &&
                null !== s.dataPoints[B - 1].y &&
                (a.axisY.logarithmic
                  ? ((t = e / s.dataPoints[B - 1].y),
                    1 > t && (t = 1 / t),
            ...
            if (b < r && !k) null !== e && (p = b);
              ...
              s.dataPoints[B].label &&
                (a.axisX.labels[b] = s.dataPoints[B].label);
        ...
        for (
          ...
          for (r = 0; r < p.dataPoints.length; r++) {
            ...
            p.dataPoints[r].x.getTime
              ? ((f = !0), (b = p.dataPoints[r].x.getTime()))
              : (b = p.dataPoints[r].x);
            e = q(p.dataPoints[r].y) ? 0 : p.dataPoints[r].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            if (0 < r) {
              if (a.axisX.logarithmic) {
                var y = b / p.dataPoints[r - 1].x;
                1 > y && (y = 1 / y);
                c.minDiff > y && 1 !== y && (c.minDiff = y);
              } else
                (y = b - p.dataPoints[r - 1].x),
                  0 > y && (y *= -1),
            ...
            if (b < da && !g) null !== p.dataPoints[r].y && (h = b);
            else {
              if (!g && ((g = !0), 0 < r)) {
                r -= 2;
                continue;
    ...
    n.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          for (p = 0; p < m.dataPoints.length; p++) {
            ...
            m.dataPoints[p].x.getTime
              ...
              : (b = m.dataPoints[p].x);
            e = q(m.dataPoints[p].y) ? null : m.dataPoints[p].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            if (0 < p) {
              if (a.axisX.logarithmic) {
        ...
        a.axisY.logarithmic
          ? ((d.max = q(d.viewPortMax)
              ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
              : Math.max(
                  d.viewPortMax,
                  99 * Math.pow(a.axisY.logarithmBase, -0.05)
                )),
            (d.min = q(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
          : l && !s
          ? ((d.max = q(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)),
            (d.min = q(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
          : l && s
          ? ((d.max = q(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)),
            (d.min = q(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)))
          : !l &&
            s &&
            ((d.max = q(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)),
            (d.min = q(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
        d.viewPortMin = d.min;
        d.viewPortMax = d.max;
        a.dataPointYSums = B;
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (B = 0; B < s.dataPoints.length; B++)
            "undefined" !== typeof s.dataPoints[B].isCumulativeSum &&
            !0 === s.dataPoints[B].isCumulativeSum
              ? ((s.dataPointEOs[B].cumulativeSumYStartValue = 0),
                (s.dataPointEOs[B].cumulativeSum =
                  0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                (s.dataPoints[B].y =
                  0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum))
              : "undefined" !== typeof s.dataPoints[B].isIntermediateSum &&
                !0 === s.dataPoints[B].isIntermediateSum
              ? ((s.dataPointEOs[B].cumulativeSumYStartValue = p),
                (s.dataPointEOs[B].cumulativeSum =
                  0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                (s.dataPoints[B].y = 0 === B ? 0 : b),
                (p = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof s.dataPoints[B].y
                    ? 0
                    : s.dataPoints[B].y),
                (s.dataPointEOs[B].cumulativeSumYStartValue =
                  0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum),
                (s.dataPointEOs[B].cumulativeSum =
                  0 === B ? e : s.dataPointEOs[B - 1].cumulativeSum + e),
                (b += e));
          for (B = 0; B < s.dataPoints.length; B++)
            if (
              ("undefined" === typeof s.dataPoints[B].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              s.dataPointEOs[B].cumulativeSum < d.min &&
                (d.min = s.dataPointEOs[B].cumulativeSum),
              s.dataPointEOs[B].cumulativeSum > d.max &&
                (d.max = s.dataPointEOs[B].cumulativeSum),
              0 < B &&
                (a.axisX.logarithmic
                  ? ((p = b / s.dataPoints[B - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        s.dataPointEOs[B].cumulativeSum /
                        s.dataPointEOs[B - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < B &&
                (s.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = s.dataPointEOs[B - 1].cumulativeSum),
                s.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = s.dataPointEOs[B - 1].cumulativeSum));
              s.dataPointEOs[B].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = s.dataPointEOs[B].cumulativeSum);
              s.dataPointEOs[B].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = s.dataPointEOs[B].cumulativeSum);
            }
          s.axisX.valueType = s.xValueType = f ? "dateTime" : "number";
        }
    };
                  ...
                  if (
                    ...
                    if (
                      ...
                      for (var w = 0; w < g.length; w++)
                        (r = Math.floor((g[w] - m) / n)),
                          g[w] < d[r].min && (d[r].min = g[w]),
                          g[w] > d[r].max && (d[r].max = g[w]);
                    else
                      q(g) ||
                        ((r = Math.floor((g - m) / n)),
                        g < d[r].min && (d[r].min = g),
        ...
        for (l = 0; l < this._axes.length; l++)
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            if (this._axes[l].dataInfo.dataPointYPositiveSums) {
              var r = this._axes[l].dataInfo.dataPointYPositiveSums;
              m = k;
              for (s in r)
                if (r.hasOwnProperty(s) && !isNaN(s) && ((p = r[s]), !q(p))) {
            ...
            if (this._axes[l].dataInfo.dataPointYNegativeSums) {
              r = this._axes[l].dataInfo.dataPointYNegativeSums;
              m = k;
              for (s in r)
                r.hasOwnProperty(s) &&
                  !isNaN(s) &&
      ...
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if (
          ...
          if (this.panEnabled)
            ...
            this.overlaidCanvasCtx.fillRect(b, s, B, k);
    ...
    n.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (l = 0; l < k.length; l++) {
        var p = k[l],
          f = !1,
          r = p.convertPixelToValue({ x: a, y: d }),
        ...
        if (p.scaleBreaks)
          for (t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++)
            f =
              p.scaleBreaks._appliedBreaks[t].startValue <= r &&
              p.scaleBreaks._appliedBreaks[t].endValue >= g;
        if (isFinite(p.dataInfo.minDiff))
          if (
            ((t = p.getApparentDifference(r, g, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
            ...
            B.push(p), m.push({ val1: r, val2: g }), (s = !0);
          else if (!e) {
            s = !1;
            break;
          }
      }
      return { isValid: s, axesWithValidRange: B, axesRanges: m };
    };
    ...
    n.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a],
          ...
          B = ma("indexLabelFontStyle", m.dataPoint, m.dataSeries),
          k = ma("indexLabelFontWeight", m.dataPoint, m.dataSeries),
          h = ma("indexLabelBackgroundColor", m.dataPoint, m.dataSeries);
        r = ma("indexLabelMaxWidth", m.dataPoint, m.dataSeries);
        g = ma("indexLabelWrap", m.dataPoint, m.dataSeries);
        var da = ma("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          u = ma("indexLabelLineColor", m.dataPoint, m.dataSeries),
          n = q(m.dataPoint.indexLabelLineThickness)
            ? q(m.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        var E = m.dataPoint.indexLabelFormatter
        ...
        if (null !== E && "" !== E) {
          var x = ma("indexLabelPlacement", m.dataPoint, m.dataSeries),
            ...
            z = ma("indexLabelTextAlign", m.dataPoint, m.dataSeries),
            v = m.direction,
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            r = m.point.x - ("horizontal" === D ? B / 2 : B / 2 - t / 2);
            "inside" !== x
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g =
                      m.point.y + ("horizontal" === D ? t / 2 : 0) - k - s - b),
                    g < e &&
                      ((g =
                        "auto" === x
                  ...
                  0 > v
                    ? ((r =
                      ...
                      r < e &&
                        ...
                        (A = r + B > m.point.x)))
                    : ((r =
                        m.point.x + ("horizontal" === D ? 0 : t / 2) + l + b),
                      r > f - B - l - b &&
                        ((r =
                          "auto" === x
          ...
          n &&
            ...
            d.setLineDash && d.setLineDash(I(da, n)),
            d.beginPath(),
            ...
            0 <= p.indexOf("bar") || ("error" === p && m.axisSwapped)
              ? d.lineTo(
                  r +
                    (0 < m.direction ? -l : B + l) +
                    ("vertical" === D ? -t / 2 : 0),
                  g + ("vertical" === D ? -k / 2 : k / 2 - t / 2) - s
                )
              : 0 <= p.indexOf("column") || ("error" === p && !m.axisSwapped)
              ? d.lineTo(
                  r + B / 2 - ("horizontal" === D ? 0 : t / 2),
                  g +
                    ("vertical" === D
                      ? (g - k < m.point.y ? 0 : -k) + s
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]),
          (h = ma("indexLabelBackgroundColor", m.dataPoint, m.dataSeries)),
          (m.dataSeries.indexLabelBackgroundColor = q(h)
            ? w
              ? "transparent"
              : null
            : h);
    ...
    n.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          var B = a.dataSeriesIndexes[s],
            k = this.data[B];
          c.lineWidth = k.lineThickness;
          var m = k.dataPoints,
            p = "solid";
          if (c.setLineDash) {
            var r = I(k.nullDataLineDashType, k.lineThickness),
              p = k.lineDashType,
          ...
          var t = k._colorSet,
            h =
              (t =
              k.lineColor =
                k.options.lineColor ? k.options.lineColor : t[0]);
          c.strokeStyle = t;
          var q = !0,
            u = 0,
            n,
                ...
                if ("number" !== typeof m[u].y)
                  ...
                  u < m.length - 1 &&
                    ...
                    c.setLineDash &&
                      (m[u].lineDashType
                        ? ((p = m[u].lineDashType),
                          c.setLineDash(I(p, k.lineThickness)))
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < m[u].markerSize || 0 < k.markerSize) {
                    var z = k.getMarkerProperties(u, n, x, c);
                    f.push(z);
                    E = O(E);
                    w &&
                      f.push({
                  ...
                  u < m.length - 1 &&
                    ...
                    c.setLineDash &&
                      (m[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < m[u].markerSize || 0 < k.markerSize)
                    (E = k.getMarkerProperties(u, n, x, c)),
                      f.push(E),
                      (z = O(z)),
                      w &&
                        f.push({
    ...
    n.prototype.renderSpline = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          b.beginPath();
          if (0 < m.length)
            for (n = !1, q = 0; q < m.length; q++)
              if (
                ((u = m[q].getTime ? m[q].x.getTime() : m[q].x),
                !(
                ...
                if ("number" !== typeof m[q].y)
                  ...
                  n = a.axisY.convertValueToPixel(m[q].y);
                  var D = k.dataPointIds[q];
                  ...
                  q < m.length - 1 &&
                    (h !== (m[q].lineColor || t) ||
                      p !== (m[q].lineDashType || k.lineDashType)) &&
                    ((h = m[q].lineColor || t),
                    (x[x.length - 1].newStrokeStyle = h),
                    b.setLineDash &&
                      (m[q].lineDashType
                        ? ((p = m[q].lineDashType),
                          (x[x.length - 1].newLineDashArray = I(
                            p,
                            k.lineThickness
                          )))
                        : ((p = k.lineDashType),
                          (x[x.length - 1].newLineDashArray = g))));
                  if (0 < m[q].markerSize || 0 < k.markerSize) {
                    var E = k.getMarkerProperties(q, u, n, b);
                    l.push(E);
                    D = O(D);
                    w &&
                      l.push({
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < t.length)
            for (
              ...
              if (
                (t[f].getTime ? (B = t[f].x.getTime()) : (B = t[f].x),
                !(
                ...
                l = a.axisX.reversed
                  ...
                  : (l -
                      ...
                      (a.previousDataSeriesCount + m) * p) <<
                    0;
                var q = a.axisX.reversed ? (l - p) << 0 : (l + p) << 0,
                  u;
                0 <= t[f].y ? (u = k) : ((u = s), (s = k));
                s > u && ((b = s), (s = u), (u = b));
                b = t[f].color
                ...
                ca(
                  c,
                  a.axisX.reversed ? q : l,
                  s,
                  a.axisX.reversed ? l : q,
                  u,
                  b,
                  0,
                  null,
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)),
                    (E = a.axisY.convertValueToPixel(B[b])),
                    (p = "undefined" !== typeof l[b] ? l[b] : r),
                    (l[b] = E);
                else if (
                ...
                ca(
                  c,
                  x,
                  a.axisY.reversed ? E : p,
                  D,
                  a.axisY.reversed ? p : E,
                  b,
                  0,
                  null,
    ...
    n.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < u.length)
            for (
              var n = 5 < g && q.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  p -= z;
                  E = r - z;
                  a.dataSeriesIndexes.length - 1 === t &&
                    1 >= Math.abs(e.y1 - p) &&
                    (p = e.y1);
                  f[b] = z + (E - p);
                } else
              ...
              if (
                ...
                s = a.axisX.reversed
                  ...
                  : (s -
                      ...
                      (a.previousDataSeriesCount + m) * p) <<
                    0;
                var q = a.axisX.reversed ? (s - p) << 0 : (s + p) << 0,
                  u;
                0 <= t[f].y ? (u = k) : ((u = l), (l = k));
                b = t[f].color
                  ? t[f].color
                ...
                ca(
                  ...
                  a.axisX.reversed ? q : s,
                  a.axisY.reversed ? u : l,
                  a.axisX.reversed ? s : q,
                  b,
                  0,
                  null,
                  h,
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)),
                    (m = l[b] ? l[b] : r),
                    (l[b] = E = a.axisY.convertValueToPixel(B[b]));
                else if (
                ...
                ca(
                  c,
                  a.axisY.reversed ? m : E,
                  x,
                  a.axisY.reversed ? E : m,
                  D,
                  b,
                  0,
                  null,
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[b] = x + (B[b] ? B[b] : 0)),
                    (m = l[b] ? l[b] : r),
                    (l[b] = x = a.axisY.convertValueToPixel(B[b]));
    ...
    n.prototype.renderArea = function (a) {
      ...
      function b() {
        E &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(q, D), l.lineTo(E.x, D), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(q, u),
          l.beginPath(),
          l.moveTo(q, u),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < t.length) {
            ...
            c = "solid";
            if (f.setLineDash) {
              var M = I(g.nullDataLineDashType, g.lineThickness);
              c = g.lineDashType;
              var Q = I(c, g.lineThickness);
              f.setLineDash(Q);
            }
            for (var ea = !0; h < t.length; h++)
              if (
                ...
                if ("number" !== typeof t[h].y)
                  ...
                  q = a.axisX.convertValueToPixel(n);
                  ...
                  h < t.length - 1 &&
                    ...
                    f.setLineDash &&
                      (t[h].lineDashType
                        ? ((c = t[h].lineDashType),
                          f.setLineDash(I(c, g.lineThickness)))
                        : ((c = g.lineDashType), f.setLineDash(Q))));
                  ...
                  0 !== t[h].markerSize &&
                    ...
                    ((n = g.getMarkerProperties(h, q, u, f)),
                    B.push(n),
                    ($ = O($)),
                    w &&
                      B.push({
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ...
            : 0 > a.axisY.viewportMaximum
            ? (q = f.y1)
            : 0 < a.axisY.viewportMinimum && (q = h);
          u = { x: c[0].x, y: c[0].y };
          b.lineTo(c[c.length - 1].x, q);
          b.lineTo(u.x, q);
          b.closePath();
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < p.length) {
            var x = m._colorSet[r % m._colorSet.length],
              D = (m.lineColor = m.options.lineColor || x),
              E = D;
            b.fillStyle = x;
            b.strokeStyle = D;
            ...
            if (b.setLineDash) {
              var A = I(m.nullDataLineDashType, m.lineThickness),
                z = m.lineDashType,
                C = I(z, m.lineThickness);
              b.setLineDash(C);
            }
            for (t = !1; r < p.length; r++)
              if (
                ((g = p[r].x.getTime ? p[r].x.getTime() : p[r].x),
                !(
                ...
                if ("number" !== typeof p[r].y)
                  ...
                  t = a.axisY.convertValueToPixel(p[r].y);
                  var M = m.dataPointIds[r];
                  ...
                  r < p.length - 1 &&
                    (E !== (p[r].lineColor || D) ||
                      z !== (p[r].lineDashType || m.lineDashType)) &&
                    ((E = p[r].lineColor || D),
                    (n[n.length - 1].newStrokeStyle = E),
                    b.setLineDash &&
                      (p[r].lineDashType
                        ? ((z = p[r].lineDashType),
                        ...
                        : ((z = m.lineDashType),
                          (n[n.length - 1].newLineDashArray = C))));
                  if (
                    0 !== p[r].markerSize &&
                    (0 < p[r].markerSize || 0 < m.markerSize)
                  ) {
                    var Q = m.getMarkerProperties(r, g, t, b);
                    l.push(Q);
                    M = O(M);
                    w &&
                      l.push({
              ...
              if (
                ...
                "number" !== typeof t[h].y
                  ...
                  : ((q = a.axisX.convertValueToPixel(n)),
                    ...
                    h < t.length - 1 &&
                      (A !== (t[h].lineColor || v) ||
                        M !== (t[h].lineDashType || g.lineDashType)) &&
                      (b(),
                      (A = t[h].lineColor || v),
                      (f.strokeStyle = A),
                      f.setLineDash &&
                        (t[h].lineDashType
                          ? ((M = t[h].lineDashType),
                            f.setLineDash(I(M, g.lineThickness)))
                          : ((M = g.lineDashType), f.setLineDash(ea)))),
                    (n = g.dataPointIds[h]),
    ...
    n.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
          var E = a.dataSeriesIndexes[D],
            z = this.data[E],
            v = z.dataPoints;
          z.dataPointIndexes = [];
          for (r = 0; r < v.length; r++)
            (E = v[r].x.getTime ? v[r].x.getTime() : v[r].x),
              (z.dataPointIndexes[E] = r),
              e[E] || (m.push(E), (e[E] = !0));
          m.sort(Ra);
        }
        for (D = 0; D < a.dataSeriesIndexes.length; D++) {
          E = a.dataSeriesIndexes[D];
          z = this.data[E];
          v = z.dataPoints;
          y = !0;
          k = [];
          ...
          if (0 < m.length) {
            var e = z._colorSet[0],
              A = (z.lineColor = z.options.lineColor || e),
              M = A;
            b.fillStyle = e;
            b.strokeStyle = A;
            ...
            x = "solid";
            if (b.setLineDash) {
              var Q = I(z.nullDataLineDashType, z.lineThickness);
              x = z.lineDashType;
              var ea = I(x, z.lineThickness);
              b.setLineDash(ea);
            }
            for (var $ = !0, r = 0; r < m.length; r++) {
              var f = m[r],
                ia = null,
                ia =
              ...
              if (
                ...
                if ("number" !== typeof ia.y)
                  ...
                  r < v.length - 1 &&
                    (M !== (v[r].lineColor || A) ||
                      x !== (v[r].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, t),
                    k.push({ x: g, y: q - oa }),
                    ...
                    b.setLineDash &&
                      (v[r].lineDashType
                        ? ((x = v[r].lineDashType),
                          b.setLineDash(I(x, z.lineThickness)))
                        : ((x = z.lineDashType), b.setLineDash(ea))));
                  if (0 <= z.dataPointIndexes[f]) {
                    var C = z.dataPointIds[z.dataPointIndexes[f]];
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < z.markerSize) &&
                    ((oa = z.getMarkerProperties(
    ...
    n.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (D = 0; D < a.dataSeriesIndexes.length; D++) {
          ...
          k = [];
          if (0 < m.length) {
            var e = z._colorSet[r % z._colorSet.length],
              A = (z.lineColor = z.options.lineColor || e),
              M = A;
            b.fillStyle = e;
            b.strokeStyle = A;
            ...
            for (var $ = !0, r = 0; r < m.length; r++) {
              ...
              if (
                ...
                if ("number" !== typeof ia.y)
                  ...
                  r < v.length - 1 &&
                    (M !== (v[r].lineColor || A) ||
                      u !== (v[r].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, t),
                    k.push({ x: g, y: y - na }),
                    ...
                    b.setLineDash &&
                      (v[r].lineDashType
                        ? ((u = v[r].lineDashType),
                          b.setLineDash(I(u, z.lineThickness)))
                        : ((u = z.lineDashType), b.setLineDash(C))));
                  if (0 <= z.dataPointIndexes[f]) {
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < z.markerSize) &&
                    ((na = z.getMarkerProperties(r, g, t, b)),
                    s.push(na),
                    (f = O(G)),
                    w &&
                      s.push({
          ...
          if (
            ...
            for (c.strokeStyle = "#4572A7 ", e = 0; e < r.length; e++)
              if (
                ...
                l = a.axisY.convertValueToPixel(r[e].y);
                var g = r[e].z,
                  n =
                    2 *
                    Math.max(
                      Math.sqrt(
                        (s === h ? q / 2 : t + ((q - t) / (s - h)) * (g - h)) /
                          Math.PI
                      ) << 0,
                      1
                    ),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < m.length) {
            ...
            for (var p = 0, r = 0, e = 0; e < m.length; e++)
              if (
          ...
          if (0 < y.length)
            for (
              ...
              if (
                ...
                r = a.axisY.convertValueToPixel(y[s].y[3]);
                var D = (h - t / 2) << 0,
                  E = (D + t) << 0,
                ...
                "candlestick" === u.type
                  ? (c.moveTo(h - v, m),
                    c.lineTo(h - v, Math.min(k, r)),
                    c.stroke(),
                    c.moveTo(h - v, Math.max(k, r)),
                    c.lineTo(h - v, p),
                    c.stroke(),
                    ca(
                      c,
                    ...
                    w &&
                      ...
                      (b.strokeStyle = e),
                      b.moveTo(h - v, m),
                      b.lineTo(h - v, Math.min(k, r)),
                      b.stroke(),
                      b.moveTo(h - v, Math.max(k, r)),
                      b.lineTo(h - v, p),
                      b.stroke(),
                      ca(
                        b,
                ...
                (y[s].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: y[s],
                    dataSeries: u,
                    point: { x: D + (E - D) / 2, y: a.axisY.reversed ? p : m },
                    direction: 1,
                    bounds: {
                      x1: D,
                      y1: Math.min(m, p),
    ...
    n.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var n = !1, n = !!a.axisY.reversed, da = 0;
          ...
          if (0 < x.length)
            for (
              var D = 5 < t && y.bevelEnabled ? !0 : !1, l = 0;
              l < x.length;
              l++
            )
              if (
                ...
                r = a.axisY.convertValueToPixel(x[l].y[4]);
                var E = (s - t / 2) << 0,
                  z = (s + t / 2) << 0,
                  e = x[l].color ? x[l].color : y._colorSet[0],
                  v = Math.round(Math.max(1, 0.15 * t)),
                  A = 0 === v % 2 ? 0 : 0.5,
                  M = x[l].whiskerColor
                    ? x[l].whiskerColor
                    : x[l].color
                  ...
                  Q =
                    "number" === typeof x[l].whiskerThickness
                      ...
                      ? y.whiskerThickness
                      : v,
                  C = x[l].whiskerDashType
                    ? x[l].whiskerDashType
                    : y.whiskerDashType,
                  $ = q(x[l].whiskerLength)
                    ? q(y.options.whiskerLength)
                      ? t
                      : y.whiskerLength
                    : x[l].whiskerLength,
                  $ =
                  ...
                  J =
                    "number" === typeof x[l].lineThickness
                      ...
                      ? y.lineThickness
                      : v,
                  R = x[l].lineDashType ? x[l].lineDashType : y.lineDashType,
                  L = 1 === Math.round(J) % 2 ? 0.5 : 0,
                  P = y.upperBoxColor,
                  T = y.lowerBoxColor,
                  ua = q(y.options.fillOpacity) ? 1 : y.fillOpacity,
                  S = y.dataPointIds[l];
                ...
                0 < na &&
                  ...
                  (c.strokeStyle = oa),
                  (c.lineWidth = na),
                  c.setLineDash && c.setLineDash(I(F, na)),
                  c.moveTo(s - G, k),
                  c.lineTo(s - G, h),
                  c.stroke(),
                  c.moveTo(s - G, p),
                ...
                0 < J &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(I(R, J)),
                  (c.strokeStyle = K),
                  (c.lineWidth = J),
                  c.moveTo(E, r - L),
                  c.lineTo(z, r - L),
                ...
                0 < Q &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(I(C, Q)),
                  (c.strokeStyle = M),
                  (c.lineWidth = Q),
                  c.moveTo((s - $ / 2) << 0, p - ia),
                  c.lineTo((s + $ / 2) << 0, p - ia),
                ...
                w &&
                  ...
                  0 < na &&
                    (b.moveTo(s - A - G, k),
                    b.lineTo(s - A - G, Math.max(h, p)),
                    b.stroke(),
                    b.moveTo(s - A - G, Math.min(h, p)),
                    b.lineTo(s - A - G, m),
                    b.stroke()),
                  ca(
                    b,
                ...
                (x[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[l],
                    dataSeries: y,
                    point: { x: E + (z - E) / 2, y: a.axisY.reversed ? h : p },
                    direction: 1,
                    bounds: {
                      x1: E,
                      y1: Math.min(h, p),
    ...
    n.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < g.length)
            for (
              var t = 5 < k && r.bevelEnabled ? !0 : !1, f = 0;
              f < g.length;
              f++
            )
              if (
                ...
                var n = a.axisX.reversed
                    ...
                    : (b -
                        ...
                        (a.previousDataSeriesCount + m) * k) <<
                      0,
                  da = a.axisX.reversed ? (n - k) << 0 : (n + k) << 0,
                  b = g[f].color
                    ? g[f].color
                    : r._colorSet[f % r._colorSet.length];
                if (l > s) {
                  var u = l;
                  l = s;
                  s = u;
                ...
                ca(
                  c,
                  a.axisX.reversed ? da : n,
                  l,
                  a.axisX.reversed ? n : da,
                  s,
                  b,
                  0,
                  b,
    ...
    n.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        w &&
          ...
          this._eventManager.ghostCtx.clip());
        for (var da = 0, u = 0; u < this.data.length; u++)
          !this.data[u].type.match(/(bar|column)/gi) ||
            !this.data[u].visible ||
            (this.data[u].type.match(/(stacked)/gi) && da) ||
            da++;
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          s = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (z ? da : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (s = this.options.dataPointMaxWidth
          ...
          u > s && (u = s);
          if (0 < v.length)
            for (var F = D._colorSet, s = 0; s < v.length; s++) {
              var e = (D.lineColor = D.options.color ? D.options.color : F[0]),
                M = {
                  color: v[s].whiskerColor
                    ...
                    ? D.whiskerColor
                    : e,
                  thickness: q(v[s].whiskerThickness)
                    ? D.whiskerThickness
                    : v[s].whiskerThickness,
                  dashType: v[s].whiskerDashType
                    ? v[s].whiskerDashType
                    : D.whiskerDashType,
                  length: q(v[s].whiskerLength)
                    ? q(D.options.whiskerLength)
                      ? u
                      : D.options.whiskerLength
                    : v[s].whiskerLength,
                  trimLength: q(v[s].whiskerLength)
                    ? q(D.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              if (
                ...
                var ea = a.axisX.convertValueToPixel(t);
                b ? (k = ea) : (h = ea);
                ea = a.axisY.convertValueToPixel(v[s].y[0]);
                b ? (m = ea) : (r = ea);
                ea = a.axisY.convertValueToPixel(v[s].y[1]);
                b ? (p = ea) : (g = ea);
                b
                  ? ((r = a.axisX.reversed
                      ? (k + ((z ? da : 1) * u) / 2 - (z ? A - 1 : 0) * u) << 0
                      : (k - ((z ? da : 1) * u) / 2 + (z ? A - 1 : 0) * u) <<
                        0),
                    (g = a.axisX.reversed ? (r - u) << 0 : (r + u) << 0))
                  : ((m = a.axisX.reversed
                      ? (h + ((z ? da : 1) * u) / 2 - (z ? A - 1 : 0) * u) << 0
                      : (h - ((z ? da : 1) * u) / 2 + (z ? A - 1 : 0) * u) <<
                        0),
                ...
                w && C(this._eventManager.ghostCtx, m, r, p, g, e, M, Q, b);
                if (
                  v[s].indexLabel ||
                  D.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      ...
                      y: b ? r + (g - r) / 2 : v[s].y[1] >= v[s].y[0] ? g : r,
                    },
                      ...
                      point: {
                        x: b
                          ? v[s].y[1] >= v[s].y[0]
                            ...
                            : m
                          : m + (p - m) / 2,
                        y: b ? r + (g - r) / 2 : v[s].y[1] >= v[s].y[0] ? r : g,
                      },
                      direction: v[s].y[1] >= v[s].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(m, p) : m,
            ...
            for (var M = !0; g < p.length; g++)
              if (
                ...
                if (
                  ...
                  q = a.axisY.convertValueToPixel(p[g].y[0]);
                  ...
                  r || M
                    ? (m.connectNullData && !r
                        ? (b.setLineDash &&
                            ...
                            ((h[h.length - 1].newLineDashArray = C),
                            (z = m.nullDataLineDashType),
                            b.setLineDash(A)),
                          b.lineTo(t, q),
                          w && e.lineTo(t, q),
                  ...
                  g < p.length - 1 &&
                    ...
                    (d(),
                    (E = p[g].lineColor || v),
                    (h[h.length - 1].newStrokeStyle = E),
                    (b.strokeStyle = E),
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((z = p[g].lineDashType),
                          (h[h.length - 1].newLineDashArray = I(
                            z,
                            m.lineThickness
                          )),
                  ...
                  if (
                    ...
                    var Q = m.getMarkerProperties(g, t, n, b);
                    f.push(Q);
                    var ea = O(u);
                    w &&
                      f.push({
                    ...
                    Q = m.getMarkerProperties(g, t, q, b);
                    f.push(Q);
                    ea = O(u);
                    w &&
                      f.push({
        ...
        if (0 < d.length) {
          ...
          if (0 < k.lineThickness) {
            ...
            for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
              if (q[g].newStrokeStyle || q[g].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(d[f].x, d[f].y),
                  q[g].newStrokeStyle && (b.strokeStyle = q[g].newStrokeStyle),
                  q[g].newLineDashArray && b.setLineDash(q[g].newLineDashArray);
              b.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
          ...
          if (0 < m.length) {
            ...
            if (b.setLineDash) {
              var z = I(k.nullDataLineDashType, k.lineThickness),
                D = k.lineDashType;
              E = I(D, k.lineThickness);
            }
            for (g = !1; p < m.length; p++)
              if (
                ((r = m[p].x.getTime ? m[p].x.getTime() : m[p].x),
                !(
                ...
                if (
                  ...
                  p < m.length - 1 &&
                    (x !== (m[p].lineColor || y) ||
                      D !== (m[p].lineDashType || k.lineDashType)) &&
                    ((x = m[p].lineColor || y),
                    (q[q.length - 1].newStrokeStyle = x),
                    b.setLineDash &&
                      (m[p].lineDashType
                        ? ((D = m[p].lineDashType),
                          (q[q.length - 1].newLineDashArray = I(
                            D,
                            k.lineThickness
                          )))
                        : ((D = k.lineDashType),
                  ...
                  if (
                    ...
                    var C = k.getMarkerProperties(p, r, g, b);
                    f.push(C);
                    var M = O(A);
                    w &&
                      f.push({
                    ...
                    C = k.getMarkerProperties(p, r, t, b);
                    f.push(C);
                    M = O(A);
                    w &&
                      f.push({
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[p - 1].lineDashType) &&
                        ((q[q.length - 1].newLineDashArray = z),
                        (D = k.nullDataLineDashType))
                      : (d(E, y), (q = []), (n = []))),
                    (g = !0);
            d(E, y);
            Z.drawMarkers(f);
              ...
              if (
                ...
                h = a.axisX.reversed
                  ? (h +
                      ...
                      (a.previousDataSeriesCount + g) * r) <<
                    0
                  : (h -
                      (a.plotType.totalDataSeries * r) / 2 +
                      (a.previousDataSeriesCount + g) * r) <<
                    0;
                var F = a.axisX.reversed ? (h - r) << 0 : (h + r) << 0;
                q > k && ((e = q), (q = k), (k = e));
                a.axisY.reversed && ((e = q), (q = k), (k = e));
                e = n.dataPointIds[l];
                this._eventManager.objectMap[e] = {
                  id: e,
                  objectType: "dataPoint",
                ...
                ca(
                  ...
                  a.axisY.reversed ? k : q,
                  a.axisX.reversed ? h : F,
                  a.axisY.reversed ? q : k,
                  M,
                  0,
                  M,
                  x,
                ...
                0 < l &&
                  A &&
                  (!D || n.connectNullData) &&
                  (D && c.setLineDash && c.setLineDash(I(C, u)),
                  c.beginPath(),
                  c.moveTo(A, z - y),
                  c.lineTo(M, Q - y),
                  0 < u && c.stroke(),
                ...
                c.strokeStyle = v[l].lineColor
                  ...
                  : "#9e9e9e";
                c.lineWidth = u;
                c.setLineDash && ((M = I(M, u)), c.setLineDash(M));
                (v[l].indexLabel ||
                  n.indexLabel ||
    ...
    var ra = function (a, d, c, b, e, f, l, h, q) {
      if (!(0 > c)) {
    ...
    n.prototype.renderPie = function (a) {
      function d() {
        if (k && m) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
            ...
            h.indexLabelLineThickness = q(f.indexLabelLineThickness)
            ...
            h.indexLabelFontSize = q(f.indexLabelFontSize)
            ...
            h.endAngle = h.startAngle + ((2 * Math.PI) / D) * Math.abs(f.y);
          ...
          (c = g[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(
                    I(c.indexLabelLineDashType, c.indexLabelLineThickness)
                  ),
                a.beginPath(),
                a.moveTo(d, e),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < m.length) {
          ...
          r = x.y + z * Math.sin(p.midAngle);
          r = Math.sqrt(Math.pow(k - s, 2) + Math.pow(c - r, 2));
          s = Math.acos(z / w);
          r = Math.acos((w * w + z * z - r * r) / (2 * z * w));
          c = r < s ? c - p.indexLabelTextBlock.y : 0;
          k = null;
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var s, q, a = 0; a < m.length; a++) {
              ...
              if (null !== u) {
                ...
                var D = 0,
                  D = b(s, q) - t;
                if (0 > D) {
                  for (var A = (q = 0), E = 0; E < m.length; E++)
                    E !== a &&
                      g[E].hemisphere === h.hemisphere &&
                      (g[E].indexLabelTextBlock.y < h.indexLabelTextBlock.y
                        ? q++
                        : A++);
                  q = (D / (q + A || 1)) * A;
                  var A = -1 * (D - q),
                  ...
                  "right" === h.hemisphere
                    ? ((E = f(a, q)),
                      (A = -1 * (D - E)),
                      (I = f(u, A)),
                      +I.toFixed(y) < +A.toFixed(y) &&
                        +E.toFixed(y) <= +q.toFixed(y) &&
                        f(a, -(A - I)))
                    : ((E = f(u, q)),
                      (A = -1 * (D - E)),
                      (I = f(a, A)),
            ...
            for (a = 0; a < m.length; a++)
              (h = g[a]),
                ...
                (q = x.y + w * Math.sin(h.midAngle)),
                (h.indexLabelTextBlock.x = u),
                (h.indexLabelTextBlock.y = q);
          for (a = 0; a < m.length; a++)
            if (
              ((h = g[a]),
              ...
              (u = u = 0),
                ...
                0 < u &&
                  (!l &&
                    ...
                    ((q =
                      "right" === h.hemisphere
                        ? r.x2 - h.indexLabelTextBlock.x
                        : h.indexLabelTextBlock.x - r.x1),
                    0.3 * h.indexLabelTextBlock.maxWidth > q
                      ? (h.indexLabelText = "")
                      : (h.indexLabelTextBlock.maxWidth = 0.85 * q),
                    0.3 * h.indexLabelTextBlock.maxWidth < q &&
                      (h.indexLabelTextBlock.x -=
                  ...
                  (!l &&
                    ...
                    ((q =
                      0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, u * q) && f(a, 2 * q)),
                  Math.abs(h.indexLabelTextBlock.x - x.x) < z &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 !== D) {
          ...
          var F = Math.min(C / z, (z - 1) / z);
          this.pieDoughnutClickHandler = function (a) {
            n.isAnimating ||
              (!q(a.dataSeries.explodeOnClick) &&
    ...
    n.prototype.renderFunnel = function (a) {
        ...
        if (u && y) {
          for (
            ...
            (t = S[z]),
              ...
              (B[z] = J - t - W);
          t = 0.5 * W;
          for (var z = 0, E = y.length - 1; z < y.length || 0 <= E; z++, E--) {
            b = u.reversed ? y[E] : y[z];
            a = b.color
              ? b.color
              : u.reversed
              ? u._colorSet[(y.length - 1 - z) % u._colorSet.length]
            ...
            A._eventManager.objectMap[s] = {
              ...
              dataPointIndex: z,
              dataSeriesIndex: 0,
              funnelSection: S[u.reversed ? y.length - 1 - z : z],
            };
            ...
            s = b.indexLabelMaxWidth
              ...
              : B[z];
            if (s > B[z] || 0 > s) s = B[z];
            x[z] = "inside" === u.indexLabelPlacement ? S[z].height : !1;
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? A.replaceKeywordsWithValue(b.indexLabel, b, u, z)
              : u.indexLabelFormatter
              ? u.indexLabelFormatter(D)
              : u.indexLabel
              ? A.replaceKeywordsWithValue(u.indexLabel, b, u, z)
              : b.label
              ? b.label
              : "";
            0 >= m && (m = 0);
            ...
            c = new ja(P, {
              ...
              backgroundColor: d,
              maxWidth: s,
              maxHeight: !1 === x[z] ? (r ? 4.28571429 * f : 1.5 * f) : x[z],
              text: b,
              padding: ba,
            });
            c.measureText();
      ...
      function e() {
        ...
        for (
          ...
          c = H[l];
          d = c.textBlock;
          b = (a = r(l) < S.length ? H[r(l)] : null) ? a.textBlock : null;
          c = c.height;
          a && d.y + c + ba > b.y && (e = !0);
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = S[l]),
              ...
              u.reversed
                ? (H[l].textBlock.y + H[l].height > pa + D &&
                    (H[l].textBlock.y = pa + D - H[l].height),
                  H[l].textBlock.y < ua - D && (H[l].textBlock.y = ua - D))
                : (H[l].textBlock.y < pa - D && (H[l].textBlock.y = pa - D),
                  H[l].textBlock.y + H[l].height > ua + D &&
                    (H[l].textBlock.y = ua + D - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < S.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = S[e]),
                ...
                u.reversed
                  ? (H[e].textBlock.y + H[e].height > pa + D &&
                      (H[e].textBlock.y = pa + D - H[e].height),
                    H[e].textBlock.y < ua - D && (H[e].textBlock.y = ua - D))
                  : (H[e].textBlock.y < pa - D && (H[e].textBlock.y = pa - D),
                    H[e].textBlock.y + H[e].height > ua + D &&
                      (H[e].textBlock.y = ua + D - H[e].height)));
        else
      ...
      function l() {
        function a(b, c) {
          ...
          d = h(b, e);
          if (d >= c) return (f.y += c), c;
          if (b == S.length - 1) return 0 < d && (f.y += d), d;
          d += a(e, c - d);
          0 < d && (f.y += d);
          return d;
        }
          ...
          for (var l, h = 1; h < k; h++) {
            ...
            for (var s = H.length - 1; 0 <= s; s--)
              !H[s].isDirty &&
                ...
                ((l = r(s)),
                !(l >= H.length - 1) &&
                  H[s].textBlock.y + H[s].height + ba > H[l].textBlock.y &&
                  (H[s].textBlock.y =
                    H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y
                      ? e + 1
                      : e - H[s].height - 1));
          }
          for (l = S.length - 1; 0 < l; l--)
            if (!H[l].isDirty) {
              e = p(l);
              ...
              if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) {
                ...
                for (
                  k = 0;
                  H[f].textBlock.y < H[e].textBlock.y + H[e].height + ba;
        ...
        for (var d, e, f, g, k, l, m = 1, q = 0; q < 2 * m; q++) {
          for (
            var n = H.length - 1;
            0 <= n &&
            !(0 <= p(n) && p(n),
            (f = H[n]),
            (g = f.textBlock),
            (l = (k = r(n) < S.length ? H[r(n)] : null) ? k.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              k &&
              e + d + ba > +l.y.toFixed(6) &&
              ((d = g.y + d + ba - l.y),
              (e = a(n, -d)),
              e < d && (0 < e && (d -= e), (e = a(r(n), d)), e != d)));
            n--
          );
          b();
        }
      ...
      function h(a, b) {
        return (
          (b < S.length ? H[b].textBlock.y : u.reversed ? pa + D : ua + D) -
          (0 > a
            ? u.reversed
              ? ua - D
              : pa - D
            : H[a].textBlock.y + H[a].height + ba)
        );
      }
      function n(a, b, c) {
        var d,
        ...
        if (0 === Y.length) l = ga;
          ...
          e =
            (D *
              (1 != Y.length || (0 != Y[0] && Y[0] != S.length - 1) ? 2 : 1)) /
            k();
          for (var s = 0; s < S.length; s++) {
            ...
            l.push(ga[s] + d);
            if (0 <= Y.indexOf(s) || (s < S.length && 0 <= Y.indexOf(s + 1)))
              d += e;
          }
        }
        g = (function () {
          for (var a = [], b = 0; b < S.length; b++) a.push(l[b] - S[b].y1);
          return a;
        })();
        var r = {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            for (e = 0; e < S.length; e++) ta(d, S[e], u.fillOpacity);
            v(d);
      ...
      function m(a) {
        for (var b, c, d, e, f = 0; f < S.length; f++)
          (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
            (c = (((S[f].y2 + S[f].y4) / 2) << 0) + e),
            (b = g(c).x2 - 1),
            (d = H[f].textBlock.x),
            ...
            H[f].isDirty ||
              ...
              a.setLineDash &&
                a.setLineDash(I(H[f].lineDashType, H[f].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke());
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            z = 0,
            C = x.height - 2 * D,
            F = Math.min(x.width - 2 * E, 2.8 * x.height),
            M = !1,
            Q = 0;
          Q < y.length;
          Q++
          ...
          if (
            (!M &&
              "undefined" !== typeof y[Q].indexLabel &&
              null !== y[Q].indexLabel &&
              0 < y[Q].indexLabel.toString().length &&
              (M = !0),
            !M &&
              "undefined" !== typeof y[Q].label &&
              null !== y[Q].label &&
              0 < y[Q].label.toString().length &&
              (M = !0),
            (!M && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof y[Q].indexLabelFormatter)
          )
            M = !0;
        M =
          M ||
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          var W = (30 * (J - a)) / 100;
          "funnel" === u.type
            ? ((O = q(u.options.neckHeight) ? 0.35 * C : u.neckHeight),
              (G = q(u.options.neckWidth) ? 0.25 * a : u.neckWidth),
              "string" === typeof O && O.match(/%$/)
                ? ((O = parseInt(O)), (O = (O * C) / 100))
                : (O = parseInt(O)),
          ...
          if (-1 !== Q) {
            if (u.reversed)
              for (F.push(V), G = Q.length - 1; 0 < G; G--)
                (V += Q[G]), F.push(V);
            else for (G = 0; G < Q.length; G++) (V += Q[G]), F.push(V);
            if (u.reversed)
              for (G = 0; G < Q.length; G++)
                F[G] < Ca
                  ? (a.push(L), E.push(Z), (ca = G))
                  : (a.push((F[G] - pa + aa * U) / aa),
                    E.push((F[G] - pa + fa * X) / fa));
            else
              for (G = 0; G < Q.length; G++)
                F[G] < Ca
                  ? (a.push((F[G] - pa + aa * U) / aa),
            ...
            for (G = 0; G < Q.length - 1; G++)
              (V = u.reversed
                ? y[y.length - 1 - G].color
                  ? y[y.length - 1 - G].color
                  : u._colorSet[(y.length - 1 - G) % u._colorSet.length]
                : y[G].color
                ? y[G].color
            ...
            for (G = 0; G < y.length; G++)
              y[G].exploded &&
                ((Q = !0), u.reversed ? Y.push(y.length - 1 - G) : Y.push(G));
            ...
            if (
              ...
              for (G = 0; G < S.length; G++)
                (S[G].x1 += z),
                  ...
                  (S[G].x3 += z),
                  (S[G].x4 += z),
                  S[G].x5 && ((S[G].x5 += z), (S[G].x6 += z)),
                  (H[G].textBlock.x += z);
            }
            for (G = 0; G < S.length; G++)
              (z = S[G]), ta(P, z, u.fillOpacity), ga.push(z.y1);
            v(P);
            M &&
              u.visible &&
              ...
              for (G = 0; G < y.length; G++)
                (z = u.dataPointIds[G]),
                  (a = {
                    ...
                    dataPointIndex: G,
                    dataSeriesIndex: 0,
                    funnelSection: S[u.reversed ? y.length - 1 - G : G],
                  }),
                  (A._eventManager.objectMap[z] = a);
            !A.animationEnabled && Q
              ? n(A, -1, 0)
    ...
    n.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        var l = "#percent",
          h = "#total",
          q = this.getPercentAndTotal(c, d),
          h = isNaN(q.total) ? h : q.total,
          l = isNaN(q.percent) ? l : q.percent;
        do {
          q = "";
          ...
          a = a.replace("#percent", Y(l, q, f._cultureInfo));
          a = a.replace(
            "#total",
            Y(
              h,
    ...
    P.prototype.setLayout = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        h = (this.markerMargin =
          ...
          !q(this.chart.options.legend.markerMargin)
            ...
            if ("horizontal" === this.orientation) {
              ...
              if (
                ...
                (p = { items: [], width: 0 }),
                  ...
                  (this.height += g),
                  (g = 0);
              g = Math.max(g, r.textBlock.height);
            } else
              (r.textBlock = new ja(this.ctx, {
                x: 0,
                y: 0,
    ...
    P.prototype.render = function () {
      ...
      for (var h = 0, q = 0; q < l.length; q++) {
        for (var k = l[q], m = 0, p = 0; p < k.items.length; p++) {
          var r = k.items[p],
            g =
              r.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing),
            n = d + h,
            w = g;
          ...
          r.textBlock.y = Math.round(n + this.lineHeight / 2);
          r.textBlock.render(!0);
          this.ctx.restore();
          m = 0 < p ? Math.max(m, r.textBlock.height) : r.textBlock.height;
          this.chart.data[r.dataSeriesIndex].visible ||
    ...
    W.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (;;) {
        f = 0 < l ? p + e : p - e;
        if (0 <= f && f < this.dataPoints.length) {
          var r = this.chart._eventManager.objectMap[this.dataPointIds[f]],
            g = this.dataPoints[f],
            n = null;
          if (r) {
            switch (this.type) {
              ...
              case "scatter":
                var w = ma("markerSize", g, this) || 4,
                  v = c ? 20 : w,
                  n = Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y1 - d, 2));
                n <= v &&
                  b.push({
                    dataPoint: g,
                    dataPointIndex: f,
              ...
              case "rangeSplineArea":
                ...
                v = c ? 20 : w;
                n = Math.min(
                  Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y1 - d, 2)),
                  Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y2 - d, 2))
                );
                n <= v &&
                  b.push({
                    dataPoint: g,
              ...
              case "doughnut":
                ...
                v =
                  "doughnut" === this.type
                    ...
                    : 0;
                n = Math.sqrt(Math.pow(w.x - a, 2) + Math.pow(w.y - d, 2));
                n < r.radius &&
                  n > v &&
                  ((n = Math.atan2(d - w.y, a - w.x)),
                  0 > n && (n += 2 * Math.PI),
                  (n = Number(
                    ((((180 * (n / Math.PI)) % 360) + 360) % 360).toFixed(12)
                  )),
                  (w = Number(
                    (
                  ...
                  0 === v && 1 < r.endAngle && (v = 360),
                  w >= v && 0 !== g.y && ((v += 360), n < w && (n += 360)),
                  n > w &&
                    n < v &&
                    (b.push({
                      dataPoint: g,
              ...
              case "pyramid":
                ...
                d > n.y1 &&
                  ...
                  (n.y6
                    ? d > n.y6
                      ? ((f =
                          n.x6 + ((n.x5 - n.x6) / (n.y5 - n.y6)) * (d - n.y6)),
                        (n =
                          n.x3 + ((n.x4 - n.x3) / (n.y4 - n.y3)) * (d - n.y3)))
                      : ((f =
                          n.x1 + ((n.x6 - n.x1) / (n.y6 - n.y1)) * (d - n.y1)),
                        (n =
                          n.x2 + ((n.x3 - n.x2) / (n.y3 - n.y2)) * (d - n.y2)))
                    : ((f =
                        n.x1 + ((n.x4 - n.x1) / (n.y4 - n.y1)) * (d - n.y1)),
                      (n =
                        n.x2 + ((n.x3 - n.x2) / (n.y3 - n.y2)) * (d - n.y2))),
                  a > f &&
                    a < n &&
              ...
              case "boxAndWhisker":
                if (
                  (a >= r.x1 - r.borderThickness / 2 &&
                    ...
                    d >= r.y4 - r.borderThickness / 2 &&
                    d <= r.y1 + r.borderThickness / 2) ||
              ...
              case "candlestick":
                if (
                  (a >= r.x1 - r.borderThickness / 2 &&
                    a <= r.x2 + r.borderThickness / 2 &&
                    d >= r.y2 - r.borderThickness / 2 &&
                    d <= r.y3 + r.borderThickness / 2) ||
                  (Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness &&
                    d >= r.y1 &&
                    d <= r.y4)
                )
    ...
    A.prototype.createLabels = function () {
      ...
      var p = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
        r = p.length
          ? q(this.scaleBreaks.firstBreakIndex)
            ? 0
            ...
            if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[m]
                  : Y(m, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ja(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: f,
              ...
              if (!this._labels[c].breaksLabelType) {
                ...
                if (
                  ...
                  if (
                    ...
                    if (q(this.options.labelWrap))
                      if (!q(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          b - 2 * f > p &&
                            ...
                            b >= 2 * f && b < 2.2 * f
                              ? ((this.sessionVariables.labelMaxWidth = f),
                                q(this.options.labelFontSize) &&
                                  12 < g &&
                                  ((g = Math.floor((12 / 13) * g)),
                                  a.measureText()),
                                (this.sessionVariables.labelFontSize = q(
                  ...
                  q(this.options.labelWrap))
                    ? q(this.options.labelWrap) &&
                      (this.labelWrap && !q(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelWrap = this.labelWrap),
            ...
            for (c = 0; c < this._labels.length; c++)
              (a = this._labels[c].textBlock),
                ...
                (a.fontSize = this.labelFontSize =
                  q(this.options.labelFontSize)
                    ? q(this.sessionVariables.labelFontSize)
                      ? (this.sessionVariables.labelFontSize =
                          this.labelFontSize)
                      : this.sessionVariables.labelFontSize
                    : this.options.labelFontSize),
                (a.angle = this.labelAngle =
                  q(this.options.labelAngle)
                    ? q(this.sessionVariables.labelAngle)
                      ? (this.sessionVariables.labelAngle = this.labelAngle)
                      : this.sessionVariables.labelAngle
                    : this.labelAngle),
                (a.wrap = this.labelWrap =
                  q(this.options.labelWrap)
                    ? q(this.sessionVariables.labelWrap)
                      ? (this.sessionVariables.labelWrap = this.labelWrap)
                      : this.sessionVariables.labelWrap
                    : this.options.labelWrap),
                (a.maxHeight = q(this.sessionVariables.labelMaxHeight)
                  ? (this.sessionVariables.labelMaxHeight = l)
                  : this.sessionVariables.labelMaxHeight),
                a.measureText();
        else if ("left" === this._position || "right" === this._position)
          if (
            ((f = q(this.options.labelMaxWidth)
              ? (0.3 * this.chart.width) >> 0
              : this.options.labelMaxWidth),
            (l =
              "undefined" === typeof this.options.labelWrap || this.labelWrap
            ...
            this.sessionVariables.labelMaxWidth = f;
            this.sessionVariables.labelMaxHeight = l;
            this.sessionVariables.labelAngle = q(
              this.sessionVariables.labelAngle
            )
              ? 0
              : this.sessionVariables.labelAngle;
            ...
            !q(this.sessionVariables.stripLineLabelMaxHeight)
              ...
              : (this.sessionVariables.stripLineLabelMaxHeight = A =
                  f.labelWrap
                    ...
                    : 1.5 * this.labelFontSize);
          q(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE");
        } else
          (l =
            "bottom" === this._position || "top" === this._position
            ...
            (A =
              q(f.options.labelWrap) || f.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
            q(f.labelBackgroundColor) &&
              (q(f.startValue) && 0 !== f.startValue
    ...
    A.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < r.length; g++)
        if (r[g] && r[g].scaleBreaks && r[g].scaleBreaks._appliedBreaks.length)
          for (
            var t = r[g].scaleBreaks._appliedBreaks, w = 0;
            w < t.length && !(t[w].startValue > r[g].viewportMaximum);
            w++
          )
            t[w].endValue < r[g].viewportMinimum ||
              (q(r[g].scaleBreaks.firstBreakIndex) &&
                (r[g].scaleBreaks.firstBreakIndex = w),
              t[w].startValue >= r[g].viewPortMinimum &&
                (r[g].scaleBreaks.lastBreakIndex = w));
      for (
        var v = (w = 0),
          u = 0,
          y = 0,
        ...
        r[g] &&
          r[g].title &&
          (r[g]._titleTextBlock = new ja(r[g].ctx, {
            text: r[g].title,
            horizontalAlign: "center",
        ...
        if (r[g].title)
          switch (r[g]._position) {
            case "left":
              ...
              r[g]._titleTextBlock.maxHeight = r[g].titleWrap
                ? 0.8 * f.width
                : 1.5 * r[g].titleFontSize;
            ...
            case "right":
              ...
              break;
            default:
              (r[g]._titleTextBlock.maxWidth = r[g].titleMaxWidth || f.width),
                (r[g]._titleTextBlock.maxHeight = r[g].titleWrap
                  ? 0.8 * f.height
                  : 1.5 * r[g].titleFontSize),
                (r[g]._titleTextBlock.angle = 0);
          }
      if ("normal" === e) {
        for (
          var y = [], x = [], A = [], E = [], K = [], N = [], O = [], P = [];
          ...
          if (b && 0 < b.length)
            ...
            E.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
          P.push(E);
          l = Math.round(f.x1 + S + L);
          n = Math.round(
            f.x2 - Z - Y > m.width - p ? m.width - p : f.x2 - Z - Y
          );
          if (a && 0 < a.length)
            for (y = [], g = V = 0; g < a.length; g++)
          ...
          if (d && 0 < d.length)
            for (x = [], g = X = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                ...
                (X += x[g]),
                (U += d[g] && !m.isNavigator ? d[g].margin : 0);
          else
                ...
                !a[g] ||
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < F && (l += F), 0 < h && (n -= h))),
                m.panEnabled
                  ? (V = q(m.sessionVariables.axisX.height)
                      ? (m.sessionVariables.axisX.height = V)
                      : m.sessionVariables.axisX.height)
                  : (m.sessionVariables.axisX.height = V),
                (h = Math.round(f.y2 - V - e + G)),
                (k = Math.round(f.y2)),
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + S + L)),
                ...
                d[g]._labels &&
                  ...
                  (u =
                    ...
                    (h.textBlock.height - h.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                m.panEnabled
                  ? (X = q(m.sessionVariables.axisX2.height)
                      ? (m.sessionVariables.axisX2.height = X)
                      : m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = X),
                (h = Math.round(f.y1)),
                (k = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = h + X + U - R),
              ...
              b[g] &&
                ...
                (L =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + X + U < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + U
                )),
                (L =
                  0 < a.length
                    ? 0
          ...
          for (g = 0; g < r.length; g++)
            "axisY" === r[g].type &&
              (r[g].calculateValueToPixelConversionParameters(),
              r[g].calculateBreaksSizeInValues());
          if (0 < w) {
            if (a && 0 < a.length)
              for (g = 0; g < a.length; g++)
                t = K[w - 1][g] === K[w][g] ? !0 : !1;
        ...
        K = [];
        for (N = []; 4 > w; ) {
          V = W = R = T = Y = L = U = e = P = O = G = X = 0;
          if (a && 0 < a.length)
            for (F = [], g = W = 0; g < a.length; g++)
              F.push(
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                (l = Math.round(f.x1 + W + e)),
                (n = Math.round(
                  f.x2 - V - U > m.width - 10 ? m.width - 10 : f.x2 - V - U
                )),
                c[g].labelAutoFit &&
                  !q(y) &&
                  (0 < !a.length &&
          ...
          if (m.panEnabled)
            for (g = 0; g < c.length; g++)
              p[g] = q(m.sessionVariables.axisY.height)
            ...
            for (g = 0; g < a.length; g++) {
              ...
              h =
                b && 0 < b.length
                  ...
                  ? Math.max(L, 10)
                  : f.y1;
              n = Math.round(f.x1 + W + e);
              k =
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ? c[0].lineCoordinates.y1
                        : f.y2 - T > m.height - Math.max(L, 10)
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((n = b[L].lineCoordinates.x1), (l = n - W));
              a[g].lineCoordinates = {
                x1: n - O,
                y1: h,
                x2: n - O,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((n = b[L].lineCoordinates.x2), (l = n - V));
              d[g].lineCoordinates = {
                x1: n + P,
                y1: h,
                x2: n + P,
          ...
          c =
            ...
            a /
              (this.logarithmic
                ...
                : this.conversionParameters.maximum -
                  this.conversionParameters.minimum),
          b = this.scaleBreaks && !q(this.scaleBreaks.options.spacing),
          e,
          f = 0;
        f < d.length;
        f++
      )
        (e = b || !q(d[f].options.spacing)),
          (d[f].spacing =
    ...
    A.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.setLineDash &&
            d.setLineDash(I(this.lineDashType, this.lineThickness));
          var l =
            1 === this.lineThickness % 2
              ? (this.lineCoordinates.y1 << 0) + 0.5
              : this.lineCoordinates.y1 << 0;
          d.beginPath();
          if (this.scaleBreaks && !q(this.scaleBreaks.firstBreakIndex))
            if (q(this.scaleBreaks.lastBreakIndex))
              e =
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            m = (h - q) / a / 2;
            for (r = 0; r < m; r++)
              this.ctx.lineTo(q, k), (k += 2 * f * a), (q += 2 * a), (f *= -1);
            this.ctx.lineTo(q, k);
            k += n - e;
            for (r = 0; r < m + 1; r++)
              this.ctx.lineTo(q, k), (k += 2 * f * a), (q -= 2 * a), (f *= -1);
            this.ctx.lineTo(q + a, k + f * a);
          }
        0 < p && this.ctx.stroke();
        this.ctx.closePath();
    ...
    qa(R, V);
    R.prototype.createUserOptions = function (a) {
      if ("undefined" !== typeof a || this.options._isPlaceholder) {
        var d = 0;
        this.parent.options._isPlaceholder && this.parent.createUserOptions();
        this.options._isPlaceholder ||
    ...
    aa.prototype.render = function (a, d, c) {
      ...
      this.labelMaxWidth = q(this.options.labelMaxWidth)
        ? 0.3 * this.chart.width
        : this.labelMaxWidth;
      this.labelMaxHeight =
        q(this.options.labelWrap) || this.labelWrap
          ? 0.3 * this.chart.height
          : 2 * this.labelFontSize;
      0 < p && r.setLineDash && r.setLineDash(I(this.lineDashType, p));
      k = new ja(r, {
        x: 0,
        y: 0,
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var C = 0; C < this.parent.dataSeries.length; C++)
            (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
              0 <= v.index &&
              ((v.dataSeries = this.parent.dataSeries[C]),
          ...
          if (
            ...
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(m[C].dataPoint.y[0])
                ),
                u = 0,
                t = 0;
              t < m.length;
            ...
            for (
              ...
              if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                ...
                (x += m[t].dataPoint.y),
                  (D = m[t].dataPoint.x.getTime
                    ? m[t].dataPoint.x.getTime()
                    : m[t].dataPoint.x),
                  (D = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[D])),
          ...
          if (
            ...
            b = 0;
            if (
              "rangeBar" === this.parent.dataSeries[C].type ||
              "error" === this.parent.dataSeries[C].type
            ) {
              v = Math.abs(
              ...
              k.text = this.labelFormatter
                ...
                : q(this.options.label)
                ? Y(
                    q(c) ? y.dataPoint.y[b] : c,
                    this.valueFormatString,
                    this.chart._cultureInfo
                  )
                : this.label;
            } else if ("stackedBar" === this.parent.dataSeries[C].type) {
              v = Math.abs(
                a - this.parent.convertValueToPixel(m[0].dataPoint.y)
              );
              x = u = 0;
              ...
              k.text = this.labelFormatter
                ...
                : this.label;
            } else if ("stackedBar100" === this.parent.dataSeries[C].type) {
              v = Math.abs(
                a - this.parent.convertValueToPixel(m[0].dataPoint.y)
              );
              D = x = u = 0;
              ...
              if ("axisX" === this.parent.type)
                for (
                  t = this.parent.convertPixelToValue({ y: d }),
                    v = null,
                    C = 0;
                  C < this.parent.dataSeries.length;
                  C++
                )
                  (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
                    0 <= v.index &&
          ...
          for (C = 0; C < this.parent.dataSeries.length; C++)
            (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
              0 <= v.index &&
              ((v.dataSeries = this.parent.dataSeries[C]),
              null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
          ...
          if (D) {
            if ("axisX" === this.parent.type)
              for (
                t = this.parent.convertPixelToValue({ x: a }), v = null, C = 0;
                C < this.parent.dataSeries.length;
                C++
              )
                (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
          ...
          b = 0;
          if (
            "rangeColumn" === this.parent.dataSeries[C].type ||
            "rangeArea" === this.parent.dataSeries[C].type ||
            "error" === this.parent.dataSeries[C].type ||
            "rangeSplineArea" === this.parent.dataSeries[C].type ||
            "candlestick" === this.parent.dataSeries[C].type ||
            "ohlc" === this.parent.dataSeries[C].type ||
            "boxAndWhisker" === this.parent.dataSeries[C].type
          ) {
            ...
            "stackedColumn" === this.parent.dataSeries[C].type ||
            "stackedArea" === this.parent.dataSeries[C].type
          ) {
            ...
            "stackedColumn100" === this.parent.dataSeries[C].type ||
            "stackedArea100" === this.parent.dataSeries[C].type
          ) {
            v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
            x = u = 0;
            for (t = C; 0 <= t; t--)
            ...
            k.text = this.labelFormatter
              ...
              : q(this.options.label)
              ? Y(q(c) ? D : c, this.valueFormatString, this.chart._cultureInfo)
              : this.label;
            this.value = D;
          } else
            "waterfall" === this.parent.dataSeries[C].type
              ? ((w =
                  1 === r.lineWidth % 2
        ...
        if (
          ...
          (b = e = n = 1 === r.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (f = this.chart.plotArea.y1),
            (h = this.chart.plotArea.y2),
            (this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h });
        else if (
          ...
          (f = h = w = 1 === r.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (b = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          if (
                  ...
                  (v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) &&
                    ...
                    (k.text = this.labelFormatter
                      ? this.labelFormatter({
                          ...
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: q(c) ? this.parent.convertPixelToValue(a) : c,
                        })
                      : q(this.options.label)
                      ? v.dataPoint.label
                      : this.label);
              ...
              "dateTime" === this.parent.valueType
                ? (k.text = this.labelFormatter
                    ? this.labelFormatter({
                        ...
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: q(c) ? this.parent.convertPixelToValue(d) : c,
                      })
                    : q(this.options.label)
                    ? Ba(
                        q(c) ? this.parent.convertPixelToValue(d) : c,
                        this.valueFormatString,
                        this.chart._cultureInfo
                      )
                    : this.label)
            ...
            if (
              ...
              (k.text = this.labelFormatter
                ...
                : q(this.options.label)
                ? Y(
                    q(c) ? this.parent.convertPixelToValue(a) : c,
                    this.valueFormatString,
                    this.chart._cultureInfo
                  )
                : this.label),
        ...
        "left" === this.parent._position && k.x < this.chart.bounds.x1
          ...
          : "bottom" === this.parent._position &&
            ...
            (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2);
        0 < p &&
          (r.moveTo(b, f), r.lineTo(e, h), r.stroke(), (this._hidden = !1));
        r.restore();
        this.value =
      ...
      this._textBlock = k;
      q(c) || this.renderLabel();
      r.globalAlpha = g;
    };
    aa.prototype.renderLabel = function () {
      q(this._textBlock) ||
        q(this._textBlock.text) ||
        !(
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (!q(k) && !q(k.dataPoint) && !q(k.dataPoint.y))
          ...
          if ((this.highlightObjects(f), this.enabled)) {
            ...
            if (null !== c) {
              ...
              if (
                ...
                q(this.options.content) &&
                q(this.options.contentFormatter)
              )
                for (
    ...
    X.prototype.highlightObjects = function (a) {
      ...
      if (
        q(this.chart.clearedOverlayedCanvas) ||
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      ...
      if (
        ...
        for (var n = null, q = "", h = 0; h < a.length; h++)
          (c = a[h].dataSeries),
            (b = a[h].dataPoint),
            (e = a[h].index),
            (f = ""),
                ...
                : this.chart.axisX2 &&
                  ...
                  (q +=
                    "undefined" !== typeof this.chart.axisX2[0].labels[b.x]
                      ...
                      : "{x}"),
              (q += "</br>"),
              (q = this.chart.replaceKeywordsWithValue(q, b, c, e))),
    ...
    X.prototype.showAtX = function (a, d) {
      ...
      var c,
        ...
        f = [];
      e = !1;
      d = !q(d) && 0 <= d && d < this.chart.data.length ? d : 0;
      if (this.shared)
      ...
      Z = {
        drawMarker: function (a, d, c, b, e, f, h, n) {
          if (c) {
            ...
            c.lineWidth = n ? n : 0;
            c.setLineDash && c.setLineDash(I("solid", n));
            "circle" === b
              ? (c.moveTo(a, d),
                c.beginPath(),
